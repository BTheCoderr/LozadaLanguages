        ...
        <div className="container mx-auto px-6">
          <div className="mx-auto max-w-4xl text-center mb-12">
            ...
            <p className="text-lg text-slate-600">
              Our commitment to excellence through rigorous standards and continuous development
            </p>
          </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={sector.title} className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow border border-slate-200">
